export default {
  ...
  'load': {
    'compare': {
      'description': 'Добавьте одно или несколько транспортных средств, например грузовик стандартный, контейнер и платформу. Таким образом, можно оценить, как эффективно разместится груз в различных видах транспорта и выбрать оптимальный вариант для перевозки.',
      'title': 'Сравните размещение груза в различных видах транспорта'
    },
    ...
    'select-transport': 'Для сравнения схемы загрузки груза выберите несколько видов транспорта'
  },
  '$vuetify': {
    'input': {
      'prependAction': 'Назад',
